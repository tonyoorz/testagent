...
# 数据库文件位于脚本所在目录 (database 文件夹)
DB_FILE = os.path.join(SCRIPT_DIR, 'local_data.db')
# 数据文件夹位于脚本所在目录的上一级 (pre-analysis 文件夹)
PARENT_DIR = os.path.dirname(SCRIPT_DIR)
MR_FOLDER = os.path.join(PARENT_DIR, 'mr')
DEFECT_FOLDER = os.path.join(PARENT_DIR, 'defect')
HISTORY_FOLDER = os.path.join(PARENT_DIR, 'history')
