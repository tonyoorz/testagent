...
- Inflow/Outflow (inflow-outflow-chart)
  - 总Inflow: 8637, 总Outflow: 8443, 净积压: 194, 收敛率: 97.8%
...
**对比项目**
- P1: {'count': 20, 'avg_risk_score': 19.0, 'topissue_ratio': 25.0}
- P2: {'count': 20, 'avg_risk_score': 19.0, 'topissue_ratio': 0.0}
- P3: {'count': 20, 'avg_risk_score': 19.0, 'topissue_ratio': 0.0}
...
```text
根据您的问题「最近这批问题是谁先发现的，主要卡在哪？」，我进行了以下分析：
...
**关键洞察**
1. 数据集包含 8 条记录
2. 列 'tproject' 只有一个唯一值，可能无法提供有用的区分信息
3. 列 'project' 只有一个唯一值，可能无法提供有用的区分信息
